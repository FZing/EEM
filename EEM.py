...
if  __name__ == '__main__':
    train_data = pd.read_csv(r'data\eye_data\20230619_TrainData.csv')
    train_data = train_data.iloc[:, 1:]

    val_data = pd.read_csv(r'data\eye_data\20230619_PredictionData.csv')
